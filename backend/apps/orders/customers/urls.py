...
urlpatterns = [
    ...
    path(
        ...
        name="customer_order_checkout_detail",
    ),
    ...
    path(
        "orders/<uuid:order_id>/cancel-request/",
        RequestOrderCancellationAPIView.as_view(),
        name="customer_cancel_order_request",
    ),
    path(
        "orders/items/<uuid:item_id>/cancel/",
        CancelOrderItemAPIView.as_view(),
        name="customer_cancel_order_item",
    ),
    path(
        "orders/items/<uuid:item_id>/cancel-request/",
        RequestOrderItemCancellationAPIView.as_view(),
        name="customer_cancel_order_item_request",
    ),
    path(
        "orders/<uuid:order_id>/return/",
        ReturnOrderAPIView.as_view(),
        name="customer_return_order",
    ),
    path(
        "orders/items/<uuid:item_id>/return/",
        ReturnOrderItemAPIView.as_view(),
        name="customer_return_order_item",
    ),
    path(
        "orders/<uuid:order_id>/invoice/",
        DownloadInvoiceAPIView.as_view(),
        name="customer_download_invoice",
    ),
]
