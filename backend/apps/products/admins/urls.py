...
urlpatterns = [
    ...
    path(
        "variants/<uuid:variant_id>/block/",
        ProductVariantBlockAPIView.as_view(),
        name="variant-block",
    ),
    # Product images
    path(
        "variants/<uuid:variant_id>/images/",
        ProductImageUploadAPIView.as_view(),
        name="product-image-upload",
    ),
    # Inventory Management
    path(
        "inventory/", AdminInventoryListAPIView.as_view(), name="admin-inventory-list"
    ),
    path(
        "inventory/summary/",
        AdminInventorySummaryAPIView.as_view(),
        name="admin-inventory-summary",
    ),
    path(
        "inventory/variants/<uuid:variant_id>/stock/",
        AdminUpdateStockAPIView.as_view(),
