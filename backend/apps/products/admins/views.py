...
class AdminCategoryDetailAPIView(APIView):
    ...
    def patch(self, request, uuid):
        ...
        category = AdminCategoryService.update_category(
            category_uuid=uuid, name=name, description=description, image=image
        )
        out_serializer = CategorySerializer(category, context={"request": request})
...
class ProductListCreateAPIView(APIView):
    ...
    def get(self, request):
        ...
        serializer = ProductSerializer(
            result["results"], many=True, context={"request": request}
        )
        ...
        return Response(
            {
                ...
                "message": (
                    ...
                    if product.blocked
                    else "Product unblocked successfully."
                ),
                "data": {"id": str(product.id), "blocked": product.blocked},
            }
        )
...
class ProductVariantListCreateAPIView(APIView):
    ...
    def post(self, request, product_id):
        ...
        variant = VariantService.create_variant(product, serializer.validated_data)
...
class ProductVariantDetailAPIView(APIView):
    ...
    def delete(self, request, variant_id):
        ...
        VariantService.soft_delete(variant)

        return Response({"success": True, "message": "Variant deleted successfully."})
...
class ProductVariantBlockAPIView(APIView):
    ...
    def patch(self, request, variant_id):
        ...
        variant = VariantService.toggle_block(variant)
        ...
        return Response(
            {
                ...
                "message": (
                    ...
                    if variant.blocked
                    else "Variant unblocked successfully."
                ),
                "data": {"id": str(variant.id), "blocked": variant.blocked},
            }
        )
...
class ProductImageUploadAPIView(APIView):
    ...
    def post(self, request, variant_id):
        ...
        uploaded_images = ImageService.upload_images(
            variant_id=variant_id, images=images, alt_text=alt_text
        )
    ...
    def delete(self, request, variant_id):
        ...
        if not image_id:
            return Response(
                {"success": False, "message": "image_id parameter is required."},
    ...
    def patch(self, request, variant_id):
        ...
        if not image_id:
            return Response(
                {"success": False, "message": "image_id body parameter is required."},
                status=status.HTTP_400_BAD_REQUEST,
            )
        ...
        return Response(
            {"success": True, "message": "Primary image set successfully."},
            status=status.HTTP_200_OK,
        )
...
class AdminUpdateStockAPIView(APIView):
    ...
    def patch(self, request, variant_id):
        ...
        out_serializer = AdminInventoryItemSerializer(
