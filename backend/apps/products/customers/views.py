...
from .services import CustomerCategoryService, CustomerProductService
...
class ProductListAPIView(APIView):
    ...
    def get(self, request):
        ...
        queryset = CustomerProductService.filter_brand(
            queryset, request.GET.get("brand")
        )
        ...
        queryset = CustomerProductService.apply_sort(
            queryset, request.GET.get("sort", "newest")
        )
...
class CustomerProductsByCategoryAPIView(APIView):
    ...
    def get(self, request, category_id):
        ...
        queryset = CustomerCategoryService.get_products_by_category(category_id)
