...
export function ToyCarScrollIndicator() {
  ...
  const tiltAngle =
    scrollDirection === "down" ? 8 : scrollDirection === "up" ? -8 : 0;

  return (
    <aside
      className="toy-car-scroll-wrapper"
    ...
    >
      ...
      >
        {/* Tooltip */}
        <div
          className={`toy-car-tooltip ${isHovered && !isDragging ? "visible" : ""}`}
        >
          ...
          >
            <defs>
              ...
              >
                <stop
                  offset="0%"
                  stopColor={isHovered || isDragging ? "#ffd615" : "#8c52ff"}
                />
                <stop
                  offset="50%"
                  stopColor={isHovered || isDragging ? "#f97316" : "#7b46e5"}
                />
                <stop
                  offset="100%"
                  stopColor={isHovered || isDragging ? "#ea580c" : "#5b21b6"}
                />
              </linearGradient>
            ...
            <path d="M22 17 C25 12, 35 12, 38 17 Z" fill="url(#glassGrad)" />
            <path
