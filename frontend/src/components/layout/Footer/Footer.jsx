      ...
      <div className="footer-content">
        <div className="footer-brand-section">
          ...
          <p className="footer-description">
            The premier destination for the world's most exciting toys and
            collectibles. We bridge the gap between high-end retail and pure
            imagination.
          </p>
        ...
        <div className="footer-links-columns">
          <div className="footer-column">
            ...
            <ul className="column-links">
              <li>
                <a href="#">RC Cars & Trucks</a>
              </li>
              <li>
                <a href="#">Diecast Models</a>
              </li>
              <li>
                <a href="#">STEM Tech Toys</a>
              </li>
              <li>
