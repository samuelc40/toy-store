...
export const { setSearch, setPage, setPageSize, clearSearchState } =
  adminCategoriesSlice.actions;

export const selectAdminCategories = (state) =>
  state.adminCategories.categories;
export const selectAdminCategoriesCount = (state) =>
  state.adminCategories.count;
export const selectAdminCategoriesPage = (state) => state.adminCategories.page;
export const selectAdminCategoriesPageSize = (state) =>
  state.adminCategories.page_size;
export const selectAdminCategoriesTotalPages = (state) =>
  state.adminCategories.total_pages;
export const selectAdminCategoriesSearch = (state) =>
  state.adminCategories.search;
