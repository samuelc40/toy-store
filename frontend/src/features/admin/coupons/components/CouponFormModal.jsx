...
export function CouponFormModal({
  ...
  useEffect(() => {
    ...
    if (isOpen && initialData) {
      ...
      const defaultEnd = new Date(now.setDate(now.getDate() + 30))
        .toISOString()
        .slice(0, 16);
      setFormData({
        code: "",
  ...
  const handleSubmit = async (e) => {
    ...
    if (cleanCode.length < 3) {
      ...
      errors.code =
        "Coupon code may only contain uppercase letters, numbers, and underscores.";
    }
    ...
    const payload = {
      ...
      maximum_discount_amount:
        ...
        formData.maximum_discount_amount !== null
          ? parseFloat(formData.maximum_discount_amount)
          : null,
      usage_limit:
        formData.usage_limit !== "" ? parseInt(formData.usage_limit, 10) : 0,
      per_user_limit:
        formData.per_user_limit !== ""
          ? parseInt(formData.per_user_limit, 10)
          : 1,
    };
  ...
  return createPortal(
    <div className="coupon-modal-backdrop">
      <div className="coupon-modal-card">
        ...
        <form onSubmit={handleSubmit} className="coupon-modal-body">
          {generalError && (
          ...
          <div className="coupon-modal-grid-2col">
            <div className="coupon-form-group">
              <label>Coupon Code *</label>
              <input
                type="text"
                name="code"
                className={`coupon-modal-input ${fieldErrors.code ? "input-error" : ""}`}
                value={formData.code}
                onChange={(e) => {
                  setFormData((prev) => ({
                    ...prev,
            ...
            <div className="coupon-form-group">
              ...
              <select
                name="discount_type"
                className={`coupon-modal-select ${fieldErrors.discount_type ? "input-error" : ""}`}
          ...
          <div className="coupon-modal-grid-2col">
            <div className="coupon-form-group">
              ...
              <input
                ...
                step="0.01"
                name="discount_value"
                className={`coupon-modal-input ${fieldErrors.discount_value ? "input-error" : ""}`}
                value={formData.discount_value}
                onChange={handleChange}
                placeholder={
                  formData.discount_type === "PERCENTAGE" ? "20" : "150.00"
                }
                required
              />
            ...
            <div className="coupon-form-group">
              ...
              <input
                ...
                className={`coupon-modal-input ${fieldErrors.minimum_order_amount ? "input-error" : ""}`}
          ...
          {formData.discount_type === "PERCENTAGE" && (
            <div className="coupon-form-group">
              ...
              <input
                ...
                className={`coupon-modal-input ${fieldErrors.maximum_discount_amount ? "input-error" : ""}`}
          ...
          <div className="coupon-form-group">
            ...
            <input
              type="text"
              name="description"
              className={`coupon-modal-input ${fieldErrors.description ? "input-error" : ""}`}
          ...
          <div className="coupon-modal-grid-2col">
            <div className="coupon-form-group">
              ...
              <input
                type="number"
                name="usage_limit"
                className={`coupon-modal-input ${fieldErrors.usage_limit ? "input-error" : ""}`}
            ...
            <div className="coupon-form-group">
              ...
              <input
                type="number"
                name="per_user_limit"
                className={`coupon-modal-input ${fieldErrors.per_user_limit ? "input-error" : ""}`}
          ...
          <div className="coupon-modal-grid-2col">
            <div className="coupon-form-group">
              ...
              <input
                type="datetime-local"
                name="start_date"
                className={`coupon-modal-input ${fieldErrors.start_date ? "input-error" : ""}`}
            ...
            <div className="coupon-form-group">
              ...
              <input
                type="datetime-local"
                name="end_date"
                className={`coupon-modal-input ${fieldErrors.end_date ? "input-error" : ""}`}
          ...
          >
            <input
              ...
              style={{
                width: "18px",
                height: "18px",
                accentColor: "var(--accent-color, #6366f1)",
              }}
            />
            <label
              htmlFor="is_active"
              style={{ fontSize: "13.5px", fontWeight: 600, cursor: "pointer" }}
            >
              Active Coupon
            </label>
          </div>
