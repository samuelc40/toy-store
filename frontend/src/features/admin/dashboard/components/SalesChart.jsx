  ...
  return (
    <div className="dashboard-card sales-chart-card">
      <div className="sales-chart-header">
        <div className="sales-chart-title-group">
          <TrendingUp size={20} style={{ color: "var(--accent)" }} />
          <h3 className="sales-chart-title">Sales Revenue Trend</h3>
        </div>
        <div className="sales-chart-legend">
          <div className="sales-chart-legend-item">
            <span
              style={{
                width: "12px",
                height: "12px",
      ...
      <div className="sales-chart-scroll-wrapper">
        <div
          className="sales-chart-body"
          style={{
            minWidth: labels.length > 15 ? `${labels.length * 32}px` : "100%",
          }}
        >
              ...
              >
                ...
                {isHovered && (
                  <div
                    style={{
                      position: "absolute",
                      bottom: `${Math.min(heightPct + 10, 85)}%`,
                      left: "50%",
                  ...
                  >
                    ...
                    >
                      <ShoppingBag size={11} /> {orderCnt}{" "}
                      {orderCnt === 1 ? "Order" : "Orders"}
                    </div>
                  </div>
                )}
                ...
                <span
                  style={{
                    ...
                    color: isHovered
                      ...
                      : "var(--text-secondary)",
                    whiteSpace: "nowrap",
                    transform: labels.length > 15 ? "rotate(-45deg)" : "none",
