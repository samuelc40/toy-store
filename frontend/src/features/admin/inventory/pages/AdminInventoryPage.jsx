...
export function AdminInventoryPage() {
  ...
  const renderStockBadge = (status, qty) => {
    switch (status) {
      ...
      case "LOW_STOCK":
        return (
          <span className="stock-badge badge-low-stock">LOW STOCK ({qty})</span>
        );
      default:
        return (
          <span className="stock-badge badge-in-stock">IN STOCK ({qty})</span>
        );
    }
  };
    ...
    <div className="admin-inventory-page-container">
      ...
      <div className="admin-inventory-header-banner">
        <div className="header-title-group">
          ...
          <div>
            <h1 className="admin-inventory-heading">
              Inventory &amp; Stock Management
            </h1>
            <p className="admin-inventory-subheading">
              Monitor stock levels, set inventory counts, track low stock, and
                    ...
                    >
                      ...
                      <td>
                        <div className="product-title-cell">
                          <span className="product-main-name">
                            {item.product_name}
                          </span>
                          <span className="product-variant-subname">
                            {item.variant_name}
                          </span>
                        </div>
                      </td>
