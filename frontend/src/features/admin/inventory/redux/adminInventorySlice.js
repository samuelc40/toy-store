...
export const selectInventoryCurrentPage = (state) =>
  state.adminInventory.currentPage;
export const selectInventoryPageSize = (state) => state.adminInventory.pageSize;
export const selectInventoryTotalPages = (state) =>
  state.adminInventory.totalPages;
export const selectInventorySearchQuery = (state) =>
  state.adminInventory.searchQuery;
export const selectInventorySortOrder = (state) =>
  state.adminInventory.sortOrder;
export const selectInventoryCategoryFilter = (state) =>
  state.adminInventory.categoryFilter;
export const selectInventoryBrandFilter = (state) =>
  state.adminInventory.brandFilter;
export const selectInventoryStockStatusFilter = (state) =>
  state.adminInventory.stockStatusFilter;
export const selectInventoryStatusFilter = (state) =>
  state.adminInventory.statusFilter;
export const selectInventoryLoading = (state) => state.adminInventory.loading;
export const selectInventorySummaryLoading = (state) =>
  state.adminInventory.summaryLoading;
export const selectInventoryActionLoading = (state) =>
  state.adminInventory.actionLoading;
