...
export const fetchCategoryOffersAsync = createAsyncThunk(
  ...
  async (params = {}, { rejectWithValue }) => {
    try {
      ...
      const msg =
        error.response?.data?.message || "Failed to fetch category offers.";
      return rejectWithValue(msg);
    }
  },
);
  ...
  async ({ offerId, isActive }, { rejectWithValue }) => {
    try {
      ...
      const msg =
        ...
        "Failed to toggle category offer status.";
      return rejectWithValue(msg);
    }
  },
);
...
export const deleteCategoryOfferAsync = createAsyncThunk(
  ...
  async (offerId, { rejectWithValue }) => {
    try {
      ...
      const msg =
        error.response?.data?.message || "Failed to delete category offer.";
      return rejectWithValue(msg);
    }
  },
);
...
export const fetchReferralConfigAsync = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      const msg =
        error.response?.data?.message ||
        "Failed to fetch referral offer configuration.";
      return rejectWithValue(msg);
    }
  },
);
    ...
    builder
      ...
      .addMatcher(
        (action) =>
          ...
          action.type.includes("adminOffers/") &&
...
export const { setActiveTab, setStatusFilter, setSearchQuery, setCurrentPage } =
