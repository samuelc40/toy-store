...
export const toggleProductOfferStatus = async (offerId, isActive) => {
  const response = await api.patch(`/admin/offers/products/${offerId}/`, {
    is_active: isActive,
  });
  return response.data;
};
...
export const updateCategoryOffer = async (offerId, payload) => {
  const response = await api.put(
    `/admin/offers/categories/${offerId}/`,
    payload,
  );
  return response.data;
};
...
export const toggleCategoryOfferStatus = async (offerId, isActive) => {
  const response = await api.patch(`/admin/offers/categories/${offerId}/`, {
    is_active: isActive,
  });
  return response.data;
};
