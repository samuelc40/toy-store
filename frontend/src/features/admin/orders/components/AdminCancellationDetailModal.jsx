...
export function AdminCancellationDetailModal({
  ...
  const refundVal =
    cancellationReq.refund_amount_val || orderDetails.total_amount || "0.00";
          ...
          <div className="return-highlights-bar">
            ...
            <div className="highlight-column">
              ...
              <span className="val-md font-bold text-accent">
                {cancellationReq.is_item_cancellation
            ...
            <div className="highlight-column">
              ...
              <span className="val-md font-bold">
                {cancellationReq.order_number || "N/A"}
              </span>
            </div>
            <div className="highlight-column">
              <span className="label-sm">Refund Amount</span>
              <span className="val-lg text-accent font-bold">
            ...
            <div className="highlight-column">
              ...
              <span className="val-sm">
                {cancellationReq.created_at
                  ? new Date(cancellationReq.created_at).toLocaleString(
                      "en-US",
                      {
                        year: "numeric",
                        month: "short",
              ...
              >
                ...
                >
                  {cancellationReq.item_details.image && (
                    <img
                      src={cancellationReq.item_details.image}
                      alt={cancellationReq.item_details.product_name}
                      style={{
                        width: "46px",
                        height: "46px",
                        borderRadius: "8px",
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    >
                      {cancellationReq.item_details.product_name}
                    </h4>
                    <p
                      style={{
                        margin: "3px 0 0",
                    ...
                    >
                      Variant: {cancellationReq.item_details.variant_name} |
                      Qty: x{cancellationReq.item_details.quantity} | Line
                      Total: Rs.{" "}
                      {Number(cancellationReq.item_details.line_total).toFixed(
                        2,
                      )}
                    </p>
                  </div>
          ...
          <div className="details-section-card">
            ...
            <div className="reason-info-block">
              <p className="reason-title-line">
                ...
                <span className="reason-tag">{cancellationReq.reason}</span>
              </p>
              ...
              {actionType === null ? (
                ...
                <div className="confirm-action-box">
                  <div className="confirm-header-row">
                    <span
                      className={`confirm-title ${actionType === "APPROVE" ? "success" : "danger"}`}
                    >
                      {actionType === "APPROVE"
