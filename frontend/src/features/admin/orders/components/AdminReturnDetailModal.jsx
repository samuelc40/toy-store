...
export function AdminReturnDetailModal({
  ...
  const refundVal =
    returnReq.refund_amount_val || orderDetails.total_amount || "0.00";
          ...
          <div className="return-highlights-bar">
            ...
            <div className="highlight-column">
              ...
              <span className="val-sm">
                {returnReq.requested_at
                  ? new Date(returnReq.requested_at).toLocaleString("en-US", {
                      year: "numeric",
                      month: "short",
                      day: "2-digit",
                      hour: "2-digit",
            ...
            >
              ...
              >
                {returnReq.item_details.image && (
                  <img
                    src={returnReq.item_details.image}
                    alt={returnReq.item_details.product_name}
                    style={{
                      width: "46px",
                      height: "46px",
                      borderRadius: "8px",
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    {returnReq.item_details.product_name}
                  </h4>
                  <p
                    style={{
                      margin: "3px 0 0",
                  ...
                  >
                    Variant: {returnReq.item_details.variant_name} | Qty: x
                    {returnReq.item_details.quantity} | Line Total: Rs.{" "}
                    {Number(returnReq.item_details.line_total).toFixed(2)}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="details-section-card">
            ...
            <div className="reason-info-block">
              <p className="reason-title-line">
                ...
                <span className="reason-tag">{returnReq.reason}</span>
              </p>
            ...
            <div className="nested-modal-actions">
              ...
              >
                {loading ? (
                  ...
                  "Confirm Approval & Wallet Credit"
                ) : (
                  "Confirm Rejection"
                )}
              </button>
