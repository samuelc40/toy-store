...
export function AdminCancellationsPage() {
  ...
  const handleApprove = async (cancellationId, remark) => {
    try {
      ...
      toast.success(
        res.message ||
          "Cancellation request approved, stock restored, and refund processed!",
      );
      ...
      <div className="admin-page-header">
        <div>
          ...
          <p className="admin-page-subtitle">
            Review customer cancellation requests, approve stock replenishment,
            and process refunds safely.
          </p>
        </div>
        <button
          type="button"
        ...
        <div className="admin-pagination-wrapper">
          <Pagination
            ...
            onPageSizeChange={(size) =>
              dispatch(setCancellationsPageSize(size))
            }
