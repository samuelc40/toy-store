...
export const fetchAdminReturnsAsync = createAsyncThunk(
  ...
  async (params = {}, { rejectWithValue }) => {
    try {
      ...
      const message =
        error.response?.data?.message || "Failed to load return requests.";
      return rejectWithValue(message);
    }
  },
);
...
export const approveAdminCancellationAsync = createAsyncThunk(
  ...
  async ({ cancellationId, admin_remark }, { rejectWithValue }) => {
    try {
      const data = await approveCancellationRequest(cancellationId, {
        admin_remark,
      });
      return data;
    } catch (error) {
...
export const rejectAdminCancellationAsync = createAsyncThunk(
  ...
  async ({ cancellationId, admin_remark }, { rejectWithValue }) => {
    try {
      const data = await rejectCancellationRequest(cancellationId, {
        admin_remark,
      });
      return data;
    } catch (error) {
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(updateAdminOrderStatusAsync.fulfilled, (state, action) => {
        ...
        if (
          state.activeOrder &&
          state.activeOrder.id === action.payload.data?.id
        ) {
      ...
      .addCase(approveAdminCancellationAsync.fulfilled, (state, action) => {
        ...
        const updatedReq = action.payload.data;
        if (updatedReq) {
          state.cancellations = state.cancellations.map((c) =>
            c.id === updatedReq.id ? updatedReq : c,
          );
        }
      })
...
export const selectAdminOrdersTotalPages = (state) =>
  state.adminOrders.totalPages;
...
export const selectAdminOrderStatusFilter = (state) =>
  state.adminOrders.orderStatusFilter;
export const selectAdminPaymentMethodFilter = (state) =>
  state.adminOrders.paymentMethodFilter;
export const selectAdminPaymentStatusFilter = (state) =>
  state.adminOrders.paymentStatusFilter;
export const selectAdminDateRangeFilter = (state) =>
  state.adminOrders.dateRangeFilter;
...
export const selectAdminOrderDetailLoading = (state) =>
  state.adminOrders.detailLoading;
export const selectAdminOrdersUpdateLoading = (state) =>
  state.adminOrders.updateLoading;
...
export const selectAdminReturnsCount = (state) =>
  state.adminOrders.returnsCount;
export const selectAdminReturnsTotalPages = (state) =>
  state.adminOrders.returnsTotalPages;
export const selectAdminReturnsCurrentPage = (state) =>
  state.adminOrders.returnsCurrentPage;
export const selectAdminReturnsPageSize = (state) =>
  state.adminOrders.returnsPageSize;
export const selectAdminReturnsSearchQuery = (state) =>
  state.adminOrders.returnsSearchQuery;
export const selectAdminReturnsStatusFilter = (state) =>
  state.adminOrders.returnsStatusFilter;
export const selectAdminReturnsLoading = (state) =>
  state.adminOrders.returnsLoading;
export const selectAdminProcessReturnLoading = (state) =>
  state.adminOrders.processReturnLoading;

// Cancellations Selectors
export const selectAdminCancellations = (state) =>
  state.adminOrders.cancellations;
export const selectAdminCancellationsCount = (state) =>
  state.adminOrders.cancellationsCount;
export const selectAdminCancellationsTotalPages = (state) =>
  state.adminOrders.cancellationsTotalPages;
export const selectAdminCancellationsCurrentPage = (state) =>
  state.adminOrders.cancellationsCurrentPage;
export const selectAdminCancellationsPageSize = (state) =>
  state.adminOrders.cancellationsPageSize;
export const selectAdminCancellationsSearchQuery = (state) =>
  state.adminOrders.cancellationsSearchQuery;
export const selectAdminCancellationsStatusFilter = (state) =>
  state.adminOrders.cancellationsStatusFilter;
export const selectAdminCancellationsLoading = (state) =>
  state.adminOrders.cancellationsLoading;
export const selectAdminProcessCancellationLoading = (state) =>
  state.adminOrders.processCancellationLoading;
