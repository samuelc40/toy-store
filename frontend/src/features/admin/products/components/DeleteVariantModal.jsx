    ...
    <div className="variant-modal-backdrop-overlay variant-backdrop-danger">
      <div className="variant-confirm-dialog-card animate-scale-in">
        ...
        <p className="v-confirm-dialog-message">
          ...
          <strong>{variant.variant_name}</strong> (SKU: <em>{variant.sku}</em>)?
          This perform a <strong>soft delete</strong>. The variant will be
          hidden from customer catalogs, but its inventory record is archived.
        </p>
