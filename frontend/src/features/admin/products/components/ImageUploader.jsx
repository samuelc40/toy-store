...
export function ImageUploader({
  ...
  const internalController = useImageUpload(
    variantId,
    existingImagesCount,
    onUploadSuccess,
  );
  ...
  const activeCropItem =
    activeCropIndex !== null ? queue[activeCropIndex] : null;
  ...
  return (
    <div className="variant-images-uploader-section">
      ...
      {/* Dropzone */}
      <ImageDropzone onFilesSelected={handleFilesAdded} disabled={uploading} />
