...
export function ProductDetailsView({ product, categories, onClose }) {
  ...
  const renderStockBadge = (stock) => {
    if (stock === 0) {
      ...
      return (
        <span className="p-stock-badge stock-low">Low Stock ({stock})</span>
      );
    } else {
          ...
          <div className="v-detail-info-card">
            ...
            <div className="v-info-list">
              <div className="v-info-item">
                ...
                <span className="v-info-value value-sku">
                  {selectedVariant.sku}
                </span>
              </div>
              <div className="v-info-item">
                ...
                <span className="v-info-value">
                  {selectedVariant.sale_price ? (
                    <>
                      ...
                      <span className="price-sale-green">
                        {" "}
                        Rs. {selectedVariant.sale_price}
                      </span>
                    </>
                  ) : (
                    `Rs. ${selectedVariant.price}`
              ...
              <div className="v-info-item">
                ...
                <span className="v-info-value">
                  Order #{selectedVariant.display_order}
                </span>
              </div>
            </div>
          </div>
    ...
    <div className="premium-product-details-container">
      ...
      <div className="product-meta-header-card">
        <div className="p-meta-left">
          <span className="p-meta-category-badge">
      ...
      <div className="product-details-variants-section">
        <div className="variants-section-header">
          ...
          <span className="variants-count-pill">
                ...
                >
                  ...
                  <div className="v-card-image-box">
                    {imageUrl ? (
                      ...
                      <div className="v-card-placeholder-box">
                        <ShoppingBag
                          size={20}
                          className="placeholder-icon-img"
                        />
                      </div>
                    )}
                    {v.blocked && (
                  ...
                  <div className="v-card-details-box">
                    <div className="v-card-top-row">
                      <h5 className="v-card-title-name" title={v.variant_name}>
                        {v.variant_name}
                      </h5>
                      {v.is_primary && (
                        <span className="v-card-primary-tag-badge">
                          Primary
                        </span>
                      )}
                    </div>
                    <p className="v-card-sku-code" title={`SKU: ${v.sku}`}>
                      SKU: {v.sku}
                    </p>
