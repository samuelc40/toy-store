...
export function ProductRow({
  ...
  return (
    <tr
      className={`product-table-row ${!product.is_active ? "row-deleted" : ""}`}
    >
      {/* Image Column */}
      <td data-label="IMAGE">
      ...
      <td data-label="CATEGORY">
        <span className="product-cell-category">
      ...
      <td data-label="STOCK">
        <span
          className={`product-cell-stock ${product.total_stock <= 5 && product.total_stock > 0 ? "stock-low" : product.total_stock === 0 ? "stock-empty" : ""}`}
        >
      ...
      <td data-label="CREATED">
        <span className="product-cell-created">
