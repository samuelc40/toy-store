...
export function VariantForm({
  ...
  React.useEffect(() => {
    if (backendErrors && backendErrors.sku) {
      setError("sku", {
        type: "manual",
        message: Array.isArray(backendErrors.sku)
          ? backendErrors.sku[0]
          : backendErrors.sku,
      });
    }
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="variant-form-el">
      <div className="variant-form-grid">
        ...
        <div className="v-form-group span-2">
          ...
          />
          {errors.variant_name && (
            <p className="v-form-error">{errors.variant_name.message}</p>
          )}
        </div>
        ...
        <div className="v-form-group">
          ...
          />
          {errors.price && (
            <p className="v-form-error">{errors.price.message}</p>
          )}
        </div>
        ...
        <div className="v-form-group">
          ...
          />
          {errors.sale_price && (
            <p className="v-form-error">{errors.sale_price.message}</p>
          )}
        </div>
        ...
        <div className="v-form-group">
          ...
          {errors.stock_quantity && (
            <p className="v-form-error">{errors.stock_quantity.message}</p>
          )}
        </div>
        ...
        <div className="v-form-group">
          ...
          {errors.display_order && (
            <p className="v-form-error">{errors.display_order.message}</p>
          )}
        </div>
      </div>
