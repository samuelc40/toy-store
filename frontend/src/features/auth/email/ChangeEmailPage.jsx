  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      navigate("/verify-email-change", {
        state: { new_email: data.new_email },
      });
    } catch (err) {
      ...
      <div className="auth-card">
        ...
        <div className="auth-card-header">
          ...
          <p className="auth-subtitle">
            Enter your new email address. We will send you an OTP to verify and
            activate it.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="auth-form">
          <div className="form-group">
            ...
            <div
              ...
              style={{ opacity: 0.7, backgroundColor: "var(--bg-input)" }}
            >
          ...
          <div className="form-group">
            ...
            <div
              className={`input-icon-wrapper ${errors.new_email ? "input-error" : ""}`}
            >
              <Mail className="input-field-icon" size={18} />
              <input
                type="email"
