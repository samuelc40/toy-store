  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      navigate("/reset-password", {
        state: { reset_token: resetToken, email: data.email },
      });
    } catch (err) {
      ...
      <div className="auth-card">
        ...
        <div className="auth-card-header">
          ...
          <p className="auth-subtitle">
            Please enter the 6-digit OTP sent to your email to verify reset
            request.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="auth-form">
          <div className="form-group">
            ...
            <div
              className="input-icon-wrapper input-disabled"
              style={{ opacity: 0.7, backgroundColor: "#f9f9fb" }}
            >
          ...
          <div className="form-group">
            ...
            <div
              className={`input-icon-wrapper ${errors.otp ? "input-error" : ""}`}
            >
