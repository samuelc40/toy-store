...
const signUpSchema = yup.object({
  ...
  referral_code: yup.string().nullable().notRequired(),
    ...
    <form onSubmit={handleSubmit(handleFormSubmit)} className="auth-form">
      <div className="form-row-grid">
        <div className="form-group">
          ...
          <div
            className={`input-icon-wrapper ${errors.first_name ? "input-error" : ""}`}
          >
        ...
        <div className="form-group">
          ...
          <div
            className={`input-icon-wrapper ${errors.last_name ? "input-error" : ""}`}
          >
            <User className="input-field-icon" size={18} />
            <input
              type="text"
      ...
      <div className="form-group">
        ...
        <div
          className={`input-icon-wrapper ${errors.phone ? "input-error" : ""}`}
        >
      ...
      <div className="form-group">
        ...
        <div
          className={`input-icon-wrapper ${errors.email ? "input-error" : ""}`}
        >
      ...
      <div className="form-group">
        ...
        <div
          className={`input-icon-wrapper ${errors.referral_code ? "input-error" : ""}`}
        >
      ...
      <div className="form-group">
        ...
        <div
          className={`input-icon-wrapper ${errors.password ? "input-error" : ""}`}
        >
      ...
      <div className="form-group">
        ...
        <div
          className={`input-icon-wrapper ${errors.confirm_password ? "input-error" : ""}`}
        >
          <Lock className="input-field-icon" size={18} />
          <input
            type="password"
