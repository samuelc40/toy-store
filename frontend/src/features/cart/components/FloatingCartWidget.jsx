        ...
        >
          ...
          <div className="cart-drawer-body">
            {items.length === 0 ? (
              <div className="drawer-empty-state-box">
                ...
                <span className="drawer-empty-text">
              ...
              items.map((item) => {
                ...
                return (
                  <div
                    key={item.id}
                    className={`cart-drawer-item-row ${blocked ? "is-item-blocked" : ""}`}
                  >
                    <Link
                      to={productUrl}
                      onClick={() => setDrawerOpen(false)}
          ...
          {items.length > 0 && (
            <div className="cart-drawer-footer">
              ...
              {hasBlockedItems && (
                <div
                  className="cart-checkout-warning-box"
                  style={{ margin: "8px 0" }}
                >
