      ...
      <div className="offers-hero-banner">
        <div className="offers-hero-content">
          ...
          <h1 className="offers-hero-title">
            Exclusive Store Discounts &amp; Offers
          </h1>
          <p className="offers-hero-subtitle">
            Unlock massive savings on premium toys, limited edition die-cast
            models, and category-wide special offers!
          </p>
        </div>
      </div>
      ...
      {referral_offer && (
        <div className="referral-banner-card">
          ...
          <div className="referral-banner-info">
            ...
            <p>
              Invite your friends! You get{" "}
              <strong>
                Rs. {Number(referral_offer.referrer_bonus).toFixed(0)}
              </strong>{" "}
              &amp; your friend gets{" "}
              <strong>
                Rs. {Number(referral_offer.new_user_bonus).toFixed(0)}
              </strong>{" "}
              in wallet credits when they place their first order over Rs.{" "}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="category-offer-card-content">
                      ...
                      <h3 className="category-offer-name">
                        {cOffer.category_name} Collection
                      </h3>
                      <p className="category-offer-desc">
                        Special discount automatically applied on all toys in
                        the {cOffer.category_name} category!
                      </p>
                      <Link
                        to={`/products?category=${encodeURIComponent(cOffer.category_name)}`}
                        className="btn-explore-category-offer"
                      >
                        Explore {cOffer.category_name} Toys{" "}
                        <ArrowRight size={14} />
                      </Link>
                    </div>
                  </div>
        ...
        <div className="discounted-products-section">
          ...
          {loading ? (
            ...
            <div className="offers-empty-state">
              ...
              <Link to="/products" className="btn-browse-all">
                Browse All Products
              </Link>
            </div>
          )}
