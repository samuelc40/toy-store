    ...
    <div className="modal-backdrop">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="modal-body-layout">
          {targetItem && (
            <div
              className="target-item-preview-box"
              style={{
            ...
            >
              ...
              >
                Variant: {targetItem.variant_name} | Qty: {targetItem.quantity}
              </p>
              {targetItem.estimated_refund !== undefined && (
                ...
                >
                  Estimated Refund: Rs.{" "}
                  {Number(targetItem.estimated_refund).toFixed(2)}
                </p>
              )}
            </div>
          )}
          ...
          {reason && (
            <div className="form-group">
              <label htmlFor="return_description">
                Additional Details{" "}
                {reason === "Other" && <span className="required-star">*</span>}
              </label>
              <textarea
