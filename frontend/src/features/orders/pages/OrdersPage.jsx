...
export function OrdersPage() {
  ...
  const handleConfirmCancel = async (reason) => {
    ...
    try {
      ...
      toast.success(
        `Order #${cancellingOrder.order_number} cancelled successfully.`,
      );
    ...
    <div className="orders-page-outer-container">
      ...
      <div className="orders-header-banner">
        <div className="orders-title-group">
          ...
          <div>
            ...
            <p className="orders-page-subheading">
              Track shipments, view details, manage returns, and download
              invoices.
            </p>
          </div>
        </div>
        ...
        {count > 0 && (
          <div className="orders-count-badge">
            <Sparkles size={14} />
            <span>
              {count} Total {count === 1 ? "Order" : "Orders"}
            </span>
          </div>
        )}
      </div>
      ...
      {loading && orders.length === 0 ? (
        ...
        <>
          ...
          {totalPages > 1 && (
            <nav
              className="orders-pagination-row"
              aria-label="Orders pagination navigation"
            >
              <button
                type="button"
    ...
    <div className="orders-list-grid">
      {[...Array(4)].map((_, i) => (
        ...
        >
          ...
          <div
            className="skeleton-shimmer"
            style={{ width: "40%", height: "24px", borderRadius: "6px" }}
          />
        </div>
      ))}
    </div>
