...
const CategoriesPage = () => {
  ...
  const displayCategories = (Array.isArray(categories) ? categories : []).map(
    (cat, idx) => {
      ...
      <div className="categories-page-container">
        ...
        <header className="categories-header-section">
          <h1 className="vault-main-title">
            Explore the{" "}
            <span className="vault-highlight-italic">Categories</span>
          </h1>
          <p className="vault-sub-title">
            Discover toys for every age, hobby, and imagination. From
            high-octane racing models to the deepest lore of the collectors'
            universe.
          </p>
        </header>
              ...
              >
                ...
                <div className="vault-card-frosted-overlay">
                  ...
                  <div className="vault-card-footer-row">
                    <span className="vault-card-desc">
        ...
        <div className="collector-banner-wrapper">
          <div className="collector-banner-content">
            ...
            <h2 className="collector-banner-heading">
              The 2024 Kinetic{" "}
              <span className="highlight-yellow">Collector's Guide</span> is
              here.
            </h2>
            <p className="collector-banner-paragraph">
              Dive into our curated selection of limited edition pieces,
              behind-the-scenes toy design stories, and upcoming vault releases.
            </p>
            <button
