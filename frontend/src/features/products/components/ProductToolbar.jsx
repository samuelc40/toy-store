  ...
  return (
    <div className="catalog-toolbar-container">
      ...
      <div className="toolbar-left-block">
        <SearchBar value={search} onChange={onSearchChange} loading={loading} />
      </div>
        ...
        <p className="toolbar-results-count-text">
          {totalCount > 0 ? (
            <>
              ...
              of <span className="count-bold">{totalCount}</span> Products
            </>
          ) : (
            "0 Products"
          )}
      ...
      <div className="toolbar-right-block">
        ...
        <div className="desktop-sorting-block">
          <ProductSorting value={sort} onChange={onSortChange} />
        </div>
      </div>
    </div>
  );
