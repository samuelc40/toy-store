...
function AddressCard({ address, onEdit, onDelete, onSetDefault, userName }) {
  ...
  return (
    <div
      className={`address-item-card ${address.is_default ? "default-address-card" : ""}`}
    >
      <div className="address-card-header">
        <div className="address-type-info">
          ...
          <div className="address-type-text-group">
            <span className="address-type-title">
              {getDisplayName(address.address_type)}
            </span>
            {address.is_default && (
      ...
      <div className="address-card-body">
        ...
        {address.landmark && (
          <p className="address-landmark-text">Landmark: {address.landmark}</p>
        )}
