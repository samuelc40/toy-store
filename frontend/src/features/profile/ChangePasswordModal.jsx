      ...
      if (response && typeof response === "object") {
        Object.keys(response).forEach((key) => {
          if (
            ...
            const errorMsg = Array.isArray(response[key])
              ? response[key][0]
              : response[key];
            setError(key, {
              type: "server",
      ...
      <div className="address-modal-card">
        ...
        >
          <div className="form-group">
            ...
            <div
              className={`input-icon-wrapper ${errors.current_password ? "input-error" : ""}`}
            >
          ...
          <div className="form-group">
            ...
            <div
              className={`input-icon-wrapper ${errors.new_password ? "input-error" : ""}`}
            >
              <Lock className="input-icon" size={18} />
              <input
