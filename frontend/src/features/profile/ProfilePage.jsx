...
const profileFormSchema = yup.object({
  ...
  phone: yup
    ...
    .test(
      ...
      (val) =>
        !val || (val.isdigit ? val : val.replace(/\D/g, "")).length === 10,
    ),
});
  ...
  const renderTabContent = () => {
    switch (activeTab) {
                  ...
                  <div className="profile-info-grid">
                    ...
                    <div className="profile-info-field span-2">
                      ...
                      <div className="profile-info-email-row">
                        <p className="profile-info-email-value">
                          {currentUser?.email || "-"}
                        </p>
                        <button
                          type="button"
            ...
            <div>
              ...
              <div className="addresses-list-grid">
                ...
                >
                  ...
                  <span className="dashed-card-title">
                    Add a summer home or gift recipient
                  </span>
                  <span className="dashed-card-subtext">
                    Spread the joy to more locations
                  </span>
                </div>
              </div>
            </div>
      ...
      case "wallet":
        ...
        const balanceVal = walletData?.balance
            ...
            <div className="details-card-header wallet-header-row">
              <div>
                <h2 className="details-card-title">
                  My Wallet &amp; Store Credit
                </h2>
                <p className="details-card-subtitle">
                  Manage your store refunds, credits, and view detailed
                  transaction history.
                </p>
              </div>
              <button
              ...
              >
                <RefreshCw
                  size={14}
                  className={isWalletLoading ? "spinner-icon" : ""}
                />
                <span>Refresh</span>
              </button>
            </div>
            ...
            <div className="wallet-balance-banner">
              <div className="wallet-balance-info">
                ...
                <div>
                  ...
                  <h1 className="wallet-balance-amount">Rs. {balanceVal}</h1>
                </div>
              </div>
            </div>
                ...
                {txTotalPages > 1 && (
                  <div className="wallet-tx-header-pagination">
                    ...
                    <button
                      ...
                      onClick={() =>
                        setTxPage((prev) => Math.min(txTotalPages, prev + 1))
                      }
                      className="btn-secondary-pill nav-pill"
                    >
                      <span>Next</span>
                    ...
                    return (
                      <div key={tx.id} className="wallet-tx-item-card">
                        <div className="wallet-tx-main">
                          <span
                            className={`tx-type-badge ${isCredit ? "credit" : "debit"}`}
                          >
                            {isCredit ? "+ CREDIT" : "- DEBIT"}
                          </span>
                          <div className="wallet-tx-details">
                            <p className="tx-reason">
                              {tx.transaction_reason_display ||
              ...
              {txTotalPages > 1 && (
                <div className="wallet-pagination-footer">
                  <span className="wallet-pagination-info">
                    Showing page {txPage} of {txTotalPages} ({txCount} total
                    transactions)
                  </span>
      ...
      case "settings":
        return (
          <div
            className="tab-page-content-box"
            style={{ gap: "20px", padding: "48px" }}
          >
            <h3 className="card-section-title" style={{ marginBottom: "16px" }}>
              Account Settings
            </h3>
            <p style={{ marginBottom: "24px", maxWidth: "380px" }}>
              Configure your security details, manage email subscriptions, or
              update credentials.
            </p>
            <div
              style={{
      ...
      default:
        ...
        return (
          <div className="tab-page-content-box">
            <h3>{activeLabel}</h3>
            <p>
              {activeLabel} dashboard content is currently under development.
            </p>
          </div>
        );
    }
      ...
      <aside className="profile-sidebar">
        <div className="sidebar-user-header">
          ...
          <div className="sidebar-user-meta">
            ...
            <span className="sidebar-user-badge">Gold Collector</span>
          </div>
        </div>
        ...
        <div className="sidebar-footer-menu">
          ...
          <button
            type="button"
            className="sidebar-menu-item-btn logout-btn"
