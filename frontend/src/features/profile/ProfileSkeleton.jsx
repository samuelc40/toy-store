  ...
  return (
    <div className="profile-dashboard-layout skeleton-active">
      ...
      <div className="profile-sidebar skeleton-pulse">
        <div className="sidebar-user-header">
          ...
          <div
            ...
            style={{ width: "100px", height: "14px", margin: 0 }}
          ></div>
        </div>
      ...
      <div className="profile-main-content">
        {/* Banner Skeleton */}
        <div
          className="profile-banner-card skeleton-pulse"
        ...
        <div className="profile-details-grid">
          ...
          <div className="personal-details-card skeleton-pulse">
            <div
              className="skeleton-text"
              style={{ width: "140px", height: "20px", marginBottom: "28px" }}
            ></div>
          ...
          <div className="stats-cards-stack">
            <div
              className="stat-card-item skeleton-pulse"
              style={{ backgroundColor: "#ecebf1" }}
            ></div>
            <div
              className="stat-card-item skeleton-pulse"
