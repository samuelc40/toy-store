    ...
    >
      ...
      >
        <div>
          ...
          <p
            style={{ margin: "4px 0 0 0", color: "#a09cb0", fontSize: "14px" }}
          >
            Add, edit, or delete items in the ToyVault inventory.
          </p>
        </div>
        <button
          style={{
          ...
          <tbody>
            <tr style={{ borderBottom: "1px solid #eaeaef" }}>
              ...
              >
                ...
                <span style={{ fontWeight: "700", color: "#2c2a2e" }}>
                  RC Off-Road Monster Truck
                </span>
              </td>
              <td style={{ padding: "20px 24px", color: "#7b7888" }}>
                RC Cars
              </td>
              <td
                style={{
